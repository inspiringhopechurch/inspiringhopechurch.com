...
const Beliefs = () => {
  const toggleAccordion = (event) => {
    ...
    if (classes.includes(expandedClass)) {
      parent.className = classes.replace(` ${expandedClass}`, "");
      button.ariaExpanded = "false";
    } else {
      parent.className = `${classes} ${expandedClass}`;
  ...
  return (
    <>
      ...
      <section className={`about-container box container is-shadowless`}>
        <div className={`columns content is-centered is-medium`}>
          <div className={`column is-two-thirds`}>
            ...
            <h2 className={`is-size-4 is-uppercase expanded`}>
              <button aria-expanded="true" onClick={toggleAccordion}>
                The Bible <FontAwesomeIcon icon={["fas", "plus"]} size="sm" />
              </button>
            </h2>

            <div>
              <p className={`content`}>
                The Bible was written by men divinely inspired and is the record of God’s revelation of Himself to man.
                It is a perfect treasure of divine instruction. It has God for its author, and therefore it is wholly
                without error. It reveals the depths of God’s love and the principles by which God judges us; and
            ...
            <h2 className={`is-size-4 is-uppercase`}>
              <button aria-expanded="false" onClick={toggleAccordion}>
                God <FontAwesomeIcon icon={["fas", "plus"]} size="sm" />
              </button>
            </h2>
            ...
            <div>
              ...
              <div className="pl-5">
                ...
                <p className={`content`}>
                  ...
                  all wise. God is Father in truth to those who become His children through faith in Jesus Christ. He is
                ...
                <p className={`content`}>
                  ...
                  and born of the Virgin Mary, hence the God-Man. Jesus perfectly revealed and did the will of God,
                  ...
                  on the cross He made provision for the redemption of men from sin. He was raised from the dead with a
                  glorified body and appeared to His disciples as the person who was with them before His crucifixion.
                  He ascended into heaven and is now exalted at the right hand of God where He is the One Mediator,
                  partaking of the nature of God and of man, and in whose person is effected the reconciliation between
                  God and man. He will return in power and glory to judge the world and to consummate His redemptive
            ...
            <h2 className={`is-size-4 is-uppercase`}>
              <button aria-expanded="false" onClick={toggleAccordion}>
                Man <FontAwesomeIcon icon={["fas", "plus"]} size="sm" />
              </button>
            </h2>
            ...
            <div>
              <p className={`content`}>
                ...
                In the beginning, man was innocent of sin and was endowed by his Creator with freedom of choice. By his
                free choice, man sinned against God and brought sin into the human race. Through the temptation of
                ...
                action become transgressors and are under condemnation. Only the grace of God can bring a man into His
            ...
            <div>
              ...
              <p className={`content`}>
                ...
                toward God. Faith is the acceptance of Jesus Christ and surrender of one’s entire person to Him as Lord
                and Savior. Justification is the declarative act of God by which, on the basis of the sufficiency of
                Christ’s atoning death, He pronounces every believer to be righteous, that is, to have fulfilled all of
                the requirements of the law. Justification brings the believer into a personal relationship of peace and
                favor with God.
              </p>
              <div className="tags">
              ...
              <p className={`content`}>
                ...
                God’s purposes, and is enabled to progress toward Christ-likeness through the presence and power of the
                Holy Spirit indwelling in him. Growth in grace should continue throughout the believer’s life.
              </p>
              <div className="tags">
            ...
            <div>
              ...
              <p className={`content`}>
                ...
                Christ following Scriptural teachings. Two offices serve the church. It is led and overseen by men in
                the office of pastor/elder and served by men and women in the office of deacon.
              </p>
              <p className={`content`}>
            ...
            <div>
              <p className={`content`}>
                ...
                newness of life in Christ Jesus. It is a public testimony to his faith in the final resurrection of the
                dead. Being a church ordinance, it is a prerequisite to the privileges of church membership and to the
                Lord’s Supper. The Lord’s Supper is a symbolic act of obedience whereby followers of Christ, through
                partaking of the bread and the fruit of the vine, remember the death of the Redeemer and anticipate His
                second coming.
              </p>
              <div className="tags">
