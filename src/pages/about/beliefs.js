      ...
      <section className={`box container is-shadowless`}>
        <div className={`columns content is-centered is-medium`}>
          <div className={`column is-two-thirds`}>
            ...
            <h2 className={`is-size-4 is-uppercase`}>1. The Bible</h2>

            <p className={`content`}>
              The Bible was written by men divinely inspired and is the record of God’s revelation of Himself to man. It
              is a perfect treasure of divine instruction. It has God for its author, and therefore it is wholly without
              error. It reveals the depths of God’s love and the principles by which God judges us; and therefore is,
              and will remain to the end of the world, the true center of Christian union, and the supreme standard by
              which all human conduct, creeds, and religious opinions should be tried. It is sufficient as our only
            ...
            <h2 className={`is-size-4 is-uppercase`}>2. God</h2>
            ...
            <p className={`content`}>
              ...
              perfections. To Him we owe the highest love, reverence, and obedience. The eternal God reveals Himself to
              us as Father, Son, and Holy Spirit, with distinct personal attributes, but without division of nature,
              essence, or being.
            </p>
            <div className="tags">
            ...
            <div className="pl-5">
              ...
              <p className={`content`}>
                ...
                of human history according to the purposes of His grace. He is all-powerful, all loving, and all wise.
                God is Father in truth to those who become His children through faith in Jesus Christ. He is fatherly in
              ...
              <p className={`content`}>
                ...
                and born of the Virgin Mary, hence the God-Man. Jesus perfectly revealed and did the will of God, taking
                upon Himself the demands and necessities of human nature and identifying Himself completely with
                mankind, yet without sin. He honored the divine law by His personal obedience, and in His death on the
                cross He made provision for the redemption of men from sin. He was raised from the dead with a glorified
                body and appeared to His disciples as the person who was with them before His crucifixion. He ascended
                into heaven and is now exalted at the right hand of God where He is the One Mediator, partaking of the
                nature of God and of man, and in whose person is effected the reconciliation between God and man. He
                will return in power and glory to judge the world and to consummate His redemptive mission. He now
              ...
              <p className={`content`}>
                ...
                illumination He enables men to understand truth. He exalts Christ. He convicts of sin, of righteousness,
                and of judgment. He calls men to the Savior and effects regeneration. He cultivates Christian character,
                comforts believers, and bestows spiritual gifts by which they serve God through His church. He seals the
                believer unto the day of final redemption. His presence in the Christian is the assurance of God to
                bring the believer into the fullness of the stature of Christ. He enlightens and empowers the believer
            ...
            <h2 className={`is-size-4 is-uppercase`}>3. Man</h2>
            <p className={`content`}>
              ...
              transgressed the command of God, and fell from his original innocence; whereby all men inherited a sin
              nature and an environment inclined toward sin, and as soon as they are capable of moral action become
              transgressors and are under condemnation. Only the grace of God can bring a man into His holy fellowship
              and enable man to fulfill the creative purpose of God. The sacredness of human personality is evident in
              that God created man in His own image, and in that Christ died for man; therefore every man possesses
            ...
            <p className={`content`}>
              ...
              sense, salvation includes regeneration, repentance and faith, sanctification, and glorification.
            </p>
            <p className={`content`}>
              Regeneration, or the new birth, is a work of God’s grace whereby believers become new creatures in Christ
            ...
            <p className={`content`}>
              ...
              Savior. Justification is the declarative act of God by which, on the basis of the sufficiency of Christ’s
              atoning death, He pronounces every believer to be righteous, that is, to have fulfilled all of the
            ...
            <p className={`content`}>
              There will be a final resurrection for all men, the just and unjust. Those who surrendered their lives to
            ...
            <p className={`content`}>
              A New Testament church of the Lord Jesus Christ is a local body of baptized believers who are associated
              by covenant in the faith and fellowship of the gospel, observing the two ordinances of Christ, committed
              to His teachings, exercising gifts, rights, and privileges invested in them by His Word, and seeking to
              extend this message of the gospel to the ends of the earth.
            </p>
            <p className={`content`}>
              The church is an autonomous body with each member equally responsible. It operates under the Lordship of
              Christ following Scriptural teachings. Two offices serve the church. It is led and overseen by men in the
              office of pastor/elder and served by men and women in the office of deacon.
            </p>
            <p className={`content`}>
              The New Testament speaks also of the church body as the body of Christ, which includes all of the redeemed
              of all the ages.
            </p>
            <div className="tags">
            ...
            <p className={`content`}>
              ...
              Spirit. It is an act of obedience symbolizing the believer’s faith in a crucified, buried, and risen
              Savior; the believer’s death to sin, the burial of the old life, and the resurrection to walk in newness
              of life in Christ Jesus. It is a public testimony to his faith in the final resurrection of the dead.
              Being a church ordinance, it is a prerequisite to the privileges of church membership and to the Lord’s
